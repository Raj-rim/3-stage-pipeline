...
(
    ...
    // FIX 1: renamed from execute_imm → immediate (matches pipeline_fixed.v)
    ...
    // FIX 2: renamed from alu_op → alu_operation (matches pipeline_fixed.v)
...
// Subtraction results for branch comparison
...
// FIX 3: use immediate (renamed port) in write_address
...
always @(*) begin
    ...
    case (1'b1)
        ...
        jalr: begin
            next_pc      = alu_operand1 + immediate;
            branch_taken = !branch_stall;
        end
        branch: begin
            case (alu_operation)
                BEQ: begin
                    if (ex_result_subs[31:0] == 0) begin
                        next_pc      = pc + immediate;
                        branch_taken = !branch_stall;
                    end
                end
...
always @(*) begin
    case (1'b1)
        ...
        lui:          ex_result = immediate;
        alu: begin
            // FIX 2: use renamed alu_operation
            case (alu_operation)
