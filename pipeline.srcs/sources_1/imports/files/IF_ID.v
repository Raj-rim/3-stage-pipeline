...
// FIX 1: Changed to active-low reset (negedge reset, !reset condition)
...
always @(*) begin
    ...
    case (instruction_i[`OPCODE])
        ...
        BRANCH: immediate = {{19{instruction_i[31]}},
        ...
        JAL   : immediate = {{11{instruction_i[31]}},
...
id_ex_reg u_id_ex (
    ...
    .immediate_sel_i  ((instruction_i[`OPCODE] == JALR)  ||
    ...
    .arithsubtype_i   (instruction_i[`SUBTYPE]),
    .pc_i             (inst_fetch_pc),
...
// FIX 2: Changed to active-low reset (negedge reset, !reset condition)
always @(posedge clk or negedge reset) begin
    if (!reset) begin
